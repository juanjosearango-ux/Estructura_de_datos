...
En cumplimiento del Código de Honor y las políticas de integridad académica de la asignatura, se declara el uso de herramientas de Inteligencia Artificial únicamente como apoyo en la redacción de la documentación en formato Markdown y en la organización del formato visual de las salidas en consola. La lógica del algoritmo, las funciones del árbol y los experimentos presentados fueron implementados por mi.
